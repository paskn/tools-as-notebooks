...
| [Zeeschuimer NDJSON → CSV](zeeschuimer_to_csv.ipynb) | Converts Zeeschuimer `.ndjson` exports into a slim `.csv` with item ID, post URL, and source platform. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/paskn/tools-as-notebooks/blob/main/zeeschuimer_to_csv.ipynb) |
